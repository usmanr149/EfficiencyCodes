...
double residual(){
  ...
  for(i=0;i<count;i++)
    {
      if(xi[0]>powl(10,energy0)) zig=-1;
      else if(powl(10,energy0)>=xi[i]) zig=i;
    }
  
  for(i=0;i<=zig;i++)
    {
      residual=(yi[i]-(powl(10,alpha)*powl(xi[i],beta)*powl(xi[i],gbest*log10(xi[i]))));
  ...
  for(i=zig+1;i<count;i++)
    {
      residual=(yi[i]-(powl(10,abest)*powl(xi[i],bbest)*powl(xi[i],cbest*log10(xi[i]))));
      fprintf(fp2,"%10.6Lf %10.6Lf %10.6Lf\n", xi[i], residual, ei[i]);
      /* printf("ei[%d] = %Lf\n", i, ei[i]); */
      /* printf("residualr = %Lf\n", yi[i]-(a + b*xi[i] + c*xi[i]*xi[i])); */
      /* printf("chisquaredr = %Lf\n", chisquaredr); */
  ...
  for(i=0;i<=zig;i++)
    {
      residual=(yi[i]-(powl(10,alpha+dbest)*powl(xi[i],beta)*powl(xi[i],gbest*log10(xi[i]))));
      fprintf(fp2,"%10.6Lf %10.6Lf %10.6Lf\n", xi[i], residual,ei[i]);
      /* printf("ei[%d] = %Lf\n", i, ei[i]); */
      /*  printf("residuall = %Lf\n", yi[i]-(alpha + beta*xi[i] + g*xi[i]*xi[i]+d)); */
      /*  printf("chisquaredl = %Lf\n", chisquaredl); */
  ...
  for(i=zig+1;i<count;i++)
    {
      residual=(yi[i]-(powl(10,abest+dbest)*powl(xi[i],bbest)*powl(xi[i],cbest*log10(xi[i]))));
      fprintf(fp2,"%10.6Lf %10.6Lf %10.6Lf\n", xi[i], residual,ei[i]);
      /* printf("ei[%d] = %Lf\n", i, ei[i]); */
      /* printf("residualr = %Lf\n", yi[i]-(a + b*xi[i] + c*xi[i]*xi[i]+d)); */
      /* printf("chisquaredr = %Lf\n", chisquaredr); */
  ...
  for(i=0;i<=zig;i++)
    {
      residual=(yi[i]-(powl(10,alpha+fbest)*powl(xi[i],beta)*powl(xi[i],gbest*log10(xi[i]))));
      fprintf(fp2,"%10.6Lf %10.6Lf %10.6Lf\n", xi[i], residual,ei[i]);
      /* printf("ei[%d] = %Lf\n", i, ei[i]); */
      /*  printf("residuall = %Lf\n", yi[i]-(alpha + beta*xi[i] + g*xi[i]*xi[i]+f)); */
      /*  printf("chisquaredl = %Lf\n", chisquaredl); */
  ...
  for(i=zig+1;i<count;i++)
    {
      residual=(yi[i]-(powl(10,abest+fbest)*powl(xi[i],bbest)*powl(xi[i],cbest*log10(xi[i]))));
      fprintf(fp2,"%10.6Lf %10.6Lf %10.6Lf\n", xi[i], residual,ei[i]);
      /* printf("ei[%d] = %Lf\n", i, ei[i]); */
      /* printf("residualr = %Lf\n", (yi[i]-(a + b*xi[i] + c*xi[i]*xi[i]+f))); */
      /* printf("chisquaredr = %Lf\n", chisquaredr); */
  ...
  for(i=0;i<=zig;i++)
    {
      residual=(yi[i]-(powl(10,alpha+ebest)*powl(xi[i],beta)*powl(xi[i],gbest*log10(xi[i]))));
      fprintf(fp2,"%10.6Lf %10.6Lf %10.6Lf\n", xi[i], residual,ei[i]);
      /* printf("ei[%d] = %Lf\n", i, ei[i]); */
      /* printf("residuall = %Lf\n",(yi[i]-(alpha + beta*xi[i] + g*xi[i]*xi[i]+e))); */
      /* printf("chisquaredl = %Lf\n", chisquaredl); */
  ...
  for(i=zig+1;i<count;i++)
    {
      residual=(yi[i]-(powl(10,abest+ebest)*powl(xi[i],bbest)*powl(xi[i],cbest*log10(xi[i]))));
      fprintf(fp2,"%10.6Lf %10.6Lf %10.6Lf\n", xi[i], residual,ei[i]);
      /* printf("ei[%d] = %Lf\n", i, ei[i]); */
      /* printf("residualr = %Lf\n", yi[i]-(a + b*xi[i] + c*xi[i]*xi[i]+e)); */
      /* printf("chisquaredr = %Lf\n", chisquaredr); */
...
fprintf(pipe, "set yrange[5e-4:0.015]\n");
 ...
 fprintf(pipe, "plot 'Usmantest_scaledeff.dat' every ::0::1 using 1:2:3 title '{/Arial=12 ^{60}Co}' with yerrorbars pointtype 3 ps 1 linecolor rgb 'red', 'Usmantest_scaledeff.dat' every ::2::12 using 1:2:3 title '{/Arial=12 ^{152}Eu}' with yerrorbars pointtype 13 ps 1 linecolor rgb 'blue', 'Usmantest_scaledeff.dat' every ::13::24 using 1:2:3 title '{/Arial=12 ^{56}Co}' with yerrorbars pointtype 9 ps 1 linecolor rgb 'green', 'Usmantest_scaledeff.dat' every ::25::30 using 1:2:3 title '{/Arial=12 ^{133}Ba}' with yerrorbars pointtype 11 ps 0.8 linecolor rgb 'violet', x < %Le ? 10**(%10.6Le)*x**(%10.6Le)*x**(%10.6Le*log10(x))*10**(-sqrt(((%10.6Le+%10.6Le*log10(x)+%10.6Le*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)+%10.6Le*(log10(x)-log10(%10.6Le))**2+%10.6Le*(log10(x))**2+%10.6Le*(log10(x))*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)+%10.6Le*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)**2+%10.6Le*((log10(x)-log10(%10.6Le))**2)*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)+%10.6Le*(log10(x)-log10(%10.6Le))**4+%10.6Le*log10(x)*((log10(x)-log10(%10.6Le))**2))*%10.6Le)*1.710882)) : 1/0 notitle lt 1 lc 7 lw 1, x < %Le ? 10**(%10.6Le)*x**(%10.6Le)*x**(%10.6Le*log10(x))*10**(sqrt(((%10.6Le+%10.6Le*log10(x)+%10.6Le*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)+%10.6Le*(log10(x)-log10(%10.6Le))**2+%10.6Le*(log10(x))**2+%10.6Le*(log10(x))*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)+%10.6Le*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)**2+%10.6Le*((log10(x)-log10(%10.6Le))**2)*(2*log10(x)*log10(%10.6Le)-(log10(%10.6Le))**2)+%10.6Le*(log10(x)-log10(%10.6Le))**4+%10.6Le*log10(x)*((log10(x)-log10(%10.6Le))**2))*%10.6Le)*1.710882)) : 1/0 notitle lt 1 lc 7 lw 1, x > %Le ? (x**(%Le*log10(x)))*(x**(%Le))*(10**%Le) : 1/0  title '{/Arial=12 Best-fit}' lt 1 lc 1 lw 1, x < %Le ? (x**(%Le*log10(x)))*(x**(%Le))*(10**%Le) : 1/0  notitle lt 1 lc 1 lw 1, x > %Le ? 10**(%10.6Le+%10.6Le*log10(x)+%10.6Le*(log10(x))**2)*10**(sqrt(((%10.6Le+%10.6Le*log10(x)+%10.6Le*(log10(x))**2+%10.6Le*(log10(x))**3+%10.6Le*(log10(x))**4)*%10.6Le)*1.710882)) : 1/0 notitle lt 1 lc 7 lw 1, x > %Le ? 10**(%10.6Le+%10.6Le*log10(x)+%10.6Le*(log10(x))**2)*10**(-sqrt(((%10.6Le+%10.6Le*log10(x)+%10.6Le*(log10(x))**2+%10.6Le*(log10(x))**3+%10.6Le*(log10(x))**4)*%10.6Le)*1.710882)) : 1/0 title '{/Arial=12 90%% confidence interval}' lt 1 lc 7 lw 1 \n",energy0+5, alphabest, betabest, gbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[2][0],energy0, energy0, inverse[0][3]+inverse[3][0], energy0, inverse[1][1], inverse[1][2]+inverse[2][1],energy0, energy0, inverse[2][2], energy0, energy0, inverse[2][3]+inverse[3][2], energy0,energy0, energy0, inverse[3][3], energy0, inverse[1][3]+inverse[3][1], energy0, min,energy0+5, alphabest, betabest, gbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[2][0],energy0, energy0, inverse[0][3]+inverse[3][0], energy0, inverse[1][1], inverse[1][2]+inverse[2][1],energy0, energy0, inverse[2][2], energy0, energy0, inverse[2][3]+inverse[3][2], energy0,energy0, energy0, inverse[3][3], energy0, inverse[1][3]+inverse[3][1], energy0, min, energy0-5, cbest, bbest, abest, energy0+5, gbest, betabest, alphabest, energy0-10, abest, bbest, cbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[1][1]+inverse[2][0], inverse[2][1]+inverse[1][2], inverse[2][2],min, energy0-5, abest, bbest, cbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[1][1]+inverse[2][0], inverse[2][1]+inverse[1][2], inverse[2][2],min);

//fprintf(pipe, "plot 'Usmantest_scaledeff.dat' every ::0::1 using 1:2:3 title '{/Arial=12 ^{60}Co}' with yerrorbars pointtype 3 ps 1 linecolor rgb 'red', 'Usmantest_scaledeff.dat' every ::2::12 using 1:2:3 title '{/Arial=12 ^{152}Eu}' with yerrorbars pointtype 13 ps 1 linecolor rgb 'blue', 'Usmantest_scaledeff.dat' every ::13::24 using 1:2:3 title '{/Arial=12 ^{56}Co}' with yerrorbars pointtype 9 ps 1 linecolor rgb 'green', 'Usmantest_scaledeff.dat' every ::25::29 using 1:2:3 title '{/Arial=12 ^{133}Ba}' with yerrorbars pointtype 11 ps 0.8 linecolor rgb 'violet', x > %Lf ? (x**(%Lf*log10(x)))*(x**(%Lf))*(10**%Lf) : 1/0  notitle lt 8, x < %Lf ? (x**(%Lf*log10(x)))*(x**(%Lf))*(10**%Lf) : 1/0  notitle ls -1,  x < %Lf ? 10**(%10.6Lf)*x**(%10.6Lf)*x**(%10.6Lf*log10(x))*10**(-sqrt(((%10.6Lf+%10.6Lf*log10(x)+%10.6Lf*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(log10(x)-log10(%10.6Lf))**2+%10.6Lf*(log10(x))**2+%10.6Lf*(log10(x))*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)**2+%10.6Lf*((log10(x)-log10(%10.6Lf))**2)*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(log10(x)-log10(%10.6Lf))**4+%10.6Lf*log10(x)*((log10(x)-log10(%10.6Lf))**2))*%10.6Lf)*1.71387)) : 1/0 lt 1 lc 2 lw 2, x < %Lf ? 10**(%10.6Lf)*x**(%10.6Lf)*x**(%10.6Lf*log10(x))*10**(sqrt(((%10.6Lf+%10.6Lf*log10(x)+%10.6Lf*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(log10(x)-log10(%10.6Lf))**2+%10.6Lf*(log10(x))**2+%10.6Lf*(log10(x))*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)**2+%10.6Lf*((log10(x)-log10(%10.6Lf))**2)*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(log10(x)-log10(%10.6Lf))**4+%10.6Lf*log10(x)*((log10(x)-log10(%10.6Lf))**2))*%10.6Lf)*1.71387)) : 1/0 lt 1 lc 2 lw 2, x > %Lf ? 10**(%10.6Lf+%10.6Lf*log10(x)+%10.6Lf*(log10(x))**2)*10**(-sqrt(((%10.6Lf+%10.6Lf*log10(x)+%10.6Lf*(log10(x))**2+%10.6Lf*(log10(x))**3+%10.6Lf*(log10(x))**4)*%10.6Lf)*1.7138715277)) : 1/0 notitle  lt 1 lc 3 lw 2,  x > %Lf ? 10**(%10.6Lf+%10.6Lf*log10(x)+%10.6Lf*(log10(x))**2)*10**(sqrt(((%10.6Lf+%10.6Lf*log10(x)+%10.6Lf*(log10(x))**2+%10.6Lf*(log10(x))**3+%10.6Lf*(log10(x))**4)*%10.6Lf)*1.7138715277)) : 1/0 notitle lt 1 lc 3 lw 2 \n", energy0-20, cbest, bbest, abest, energy0+20, gbest, betabest, alphabest, energy+20, alphabest, betabest, gbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[2][0],energy0, energy0, inverse[0][3]+inverse[3][0], energy0, inverse[1][1], inverse[1][2]+inverse[2][1],energy0, energy0, inverse[2][2], energy0, energy0, inverse[2][3]+inverse[3][2], energy0,energy0, energy0, inverse[3][3], energy0, inverse[1][3]+inverse[3][1], energy0, min, energy+20, alphabest, betabest, gbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[2][0],energy0, energy0, inverse[0][3]+inverse[3][0], energy0, inverse[1][1], inverse[1][2]+inverse[2][1],energy0, energy0, inverse[2][2], energy0, energy0, inverse[2][3]+inverse[3][2], energy0,energy0, energy0, inverse[3][3], energy0, inverse[1][3]+inverse[3][1], energy0, min, energy0+20, abest, bbest, cbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[1][1]+inverse[2][0], inverse[2][1]+inverse[1][2], inverse[2][2], min, energy0-20, abest, bbest, cbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[1][1]+inverse[2][0], inverse[2][1]+inverse[1][2], inverse[2][2],min);
...
//x < 210 ? 10**(-5.9764189242)*x**(3.9252874196)*x**(-0.98929522*log10(x))*10**(-sqrt(((0.0036981129-0.0052668679*log10(x)+0.0009300129*(2*log10(x)*log10(194.354778)-(log10(194.354778))**2)-0.0046329142*(log10(x)-log10(194.354778))**2+0.0018962055*(log10(x))**2-0.0006753682*(log10(x))*(2*log10(x)*log10(194.354778)-(log10(194.354778))**2)+0.000060549707545*(2*log10(x)*log10(194.354778)-(log10(194.354778))**2)**2-0.000532857*((log10(x)-log10(194.35778))**2)*(2*log10(x)*log10(194.35778)-(log10(194.35778))**2)+0.00301655*(log10(x)-log10(194.35778))**4+0.0031462274*log10(x)*((log10(x)-log10(194.35778))**2))*7.720735)*1.71387)) : 1/0 notitle lt 1 lc 2 lw 2,

// x > 190 ? 10**(-1.20110598-0.26168591*log10(x)-0.07161528*(log10(x))**2)*10**(-sqrt(((0.00369811-0.00526687*log10(x)+0.00282622*(log10(x))**2-0.000675368*(log10(x))**3+0.0000605497*(log10(x))**4)*7.7)*1.7138715277)) : 1/0 notitle lt 1 lc 3 lw 2

//abest, bbest, cbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[1][1]+inverse[2][0], inverse[2][2]

//x < 210 ? 10**(-5.9764189242)*x**(3.9252874196)*x**(-0.98929522*log10(x))*10**(sqrt(((0.0036981129-0.0052668679*log10(x)+0.0009300129*(2*log10(x)*log10(194.354778)-(log10(194.354778))**2)-0.0046329142*(log10(x)-log10(194.354778))**2+0.0018962055*(log10(x))**2-0.0006753682*(log10(x))*(2*log10(x)*log10(194.354778)-(log10(194.354778))**2)+0.000060549707545*(2*log10(x)*log10(194.354778)-(log10(194.354778))**2)**2-0.000532857*((log10(x)-log10(194.35778))**2)*(2*log10(x)*log10(194.35778)-(log10(194.35778))**2)+0.00301655*(log10(x)-log10(194.35778))**4+0.0031462274*log10(x)*((log10(x)-log10(194.35778))**2))*7.720735)*1.71387)) : 1/0 notitle lt 1 lc 2 lw 2,

//x < 210 ? 10**(%10.6Lf)*x**(%10.6Lf)*x**(%10.6Lf*log10(x))*10**(-sqrt(((%10.6Lf+%10.6Lf*log10(x)+%10.6Lf*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(log10(x)-log10(%10.6Lf))**2+%10.6Lf*(log10(x))**2+%10.6Lf*(log10(x))*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)**2+%10.6Lf*((log10(x)-log10(%10.6Lf))**2)*(2*log10(x)*log10(%10.6Lf)-(log10(%10.6Lf))**2)+%10.6Lf*(log10(x)-log10(%10.6Lf))**4+%10.6Lf*log10(x)*((log10(x)-log10(%10.6Lf))**2))*%10.6Lf)*1.71387)) : 1/0 notitle lt 1 lc 2 lw 2, 

//alphabest, betabest, gbest, inverse[0][0], inverse[0][1]+inverse[1][0], inverse[0][2]+inverse[2][0],energy0, energy0, inverse[0][3]+inverse[3][0], energy0, inverse[1][1], inverse[1][2]+inverse[2][1], energy0, energy0, inverse[2][2], energy0, energy0, inverse[2][3]+inverse[3][2], energy0,energy0, energy0, inverse[3][3], eneegy0, inverse[1][3]+inverse[3][1], energy0, min

  //1.71387 is the student t-value for 23 dof and 90%
...
int SolveMatrix2(long double qMatrix[ROWS][COLS], long double qVector[ROWS], int d){
  ...
  /* } */
   ...
   fprintf(pipe, "set ylabel \"{/Symbol c}^{2}/{/Symbol n}\"\n");
   fprintf(pipe, "set label 'a=3.16x10^{2}' at 150,50\n");
   fprintf(pipe, "set label 'b=-4.67' at 150,45\n");
   fprintf(pipe, "set label 'c=-2.23x10^{-2}' at 150,40\n");
   fprintf(pipe, "set label 'd=-3.26x10^{-5}' at 150,35\n");
   fprintf(pipe, "plot 'Usmantest.dat' using 1:2 title '{/Symbol c}^{2}/{/Symbol n}', %10.6Le+%10.6Le*x+%10.6Le*x*x+%10.6Le*x*x*x title 'Best-fit' lt 3\n",xVector[0],xVector[1],xVector[2],xVector[3], xVector[0],xVector[1],xVector[2],xVector[3]);
...
//plot 'Usmantest_scaledeff.dat' every ::0::1 using 1:2:3 title '{/Arial=12 ^{60}Co}' with yerrorbars pointtype 3 ps 1 linecolor rgb 'red', 'Usmantest_scaledeff.dat' every ::2::12 using 1:2:3 title '{/Arial=12 ^{152}Eu}' with yerrorbars pointtype 13 ps 1 linecolor rgb 'blue', 'Usmantest_scaledeff.dat' every ::13::24 using 1:2:3 title '{/Arial=12 ^{56}Co}' with yerrorbars pointtype 9 ps 1 linecolor rgb 'green', 'Usmantest_scaledeff.dat' every ::25::29 using 1:2:3 title '{/Arial=12 ^{133}Ba}' with yerrorbars pointtype 11 ps 0.8 linecolor rgb 'violet', x < 198.338114 ? 10**(-23.936841)*x**( 20.154708)*x**( -4.632723*log10(x))*10**(-sqrt(((  0.001470+ -0.001912*log10(x)+  0.000313*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)+ -0.002956*(log10(x)-log10(178.338114))**2+  0.000632*(log10(x))**2+ -0.000209*(log10(x))*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)+  0.000017*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)**2+ -0.000300*((log10(x)-log10(178.338114))**2)*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)+  0.003002*(log10(x)-log10(178.338114))**4+  0.001884*log10(x)*((log10(x)-log10(178.338114))**2))* 24.744807)*1.71387)) : 1/0 notitle lt 1 lc 2 lw 2, x < 198.338114 ? 10**(-23.936841)*x**( 20.154708)*x**( -4.632723*log10(x))*10**(sqrt(((  0.001470+ -0.001912*log10(x)+  0.000313*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)+ -0.002956*(log10(x)-log10(178.338114))**2+  0.000632*(log10(x))**2+ -0.000209*(log10(x))*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)+  0.000017*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)**2+ -0.000300*((log10(x)-log10(178.338114))**2)*(2*log10(x)*log10(178.338114)-(log10(178.338114))**2)+  0.003002*(log10(x)-log10(178.338114))**4+  0.001884*log10(x)*((log10(x)-log10(178.338114))**2))* 24.744807)*1.71387)) : 1/0 notitle lt 1 lc 2 lw 2, x > 158.338114 ? (x**(-0.069790*log10(x)))*(x**(-0.389844))*(10**-0.811441) : 1/0  notitle lt 8, x < 198.338114 ? (x**(-4.632723*log10(x)))*(x**(20.154708))*(10**-23.936841) : 1/0  notitle ls -1, x > 158.338114 ? 10**( -0.811441+ -0.389844*log10(x)+ -0.069790*(log10(x))**2)*10**(sqrt(((  0.001470+ -0.001912*log10(x)+  0.000945*(log10(x))**2+ -0.000209*(log10(x))**3+  0.000017*(log10(x))**4)* 24.744807)*1.7138715277)) : 1/0 notitle lt 1 lc 3 lw 2, x > 158.338114 ? 10**( -0.811441+ -0.389844*log10(x)+ -0.069790*(log10(x))**2)*10**(-sqrt(((  0.001470+ -0.001912*log10(x)+  0.000945*(log10(x))**2+ -0.000209*(log10(x))**3+  0.000017*(log10(x))**4)* 24.744807)*1.7138715277)) : 1/0 notitle lt 1 lc 3 lw 2

//  plot x > 158.338114 ? 10**( -0.811441+ -0.389844*log10(x)+ -0.069790*(log10(x))**2)*10**(sqrt(((  0.001470+ -0.001912*log10(x)+  0.000945*(log10(x))**2+ -0.000209*(log10(x))**3+  0.000017*(log10(x))**4)* 24.744807)*1.7138715277)) : 1/0 notitle lt 1 lc 3 lw 2

...
long double First_order_der(){
  ...
  long double F_prime[40][10], F_primeT[10][40];
  int jasper = 0;
  int a,b,i;
  //intialize
  for(a=0;a<40;a++){
  ...
  printf("energy0 = %Lf\n", energy0);
   ...
   for(i=0; i<count;i++)
	 ...
	 F_prime[i][3] = (xi[i]-energy0)*(xi[i]-energy0);
	 F_prime[i][4] = 0;
	 F_prime[i][5] = 0;
	 F_prime[i][6] = 0;
	 F_prime[i][7] = cbest*(2*xi[i]-2*energy0)+gbest*2*(xi[i] - energy0);
       }
   ...
   for(i=0; i<count;i++)
	 ...
	 F_prime[jasper+i][3] = (xi[i]-energy0)*(xi[i]-energy0);
	 F_prime[jasper+i][4] = 1;
	 F_prime[jasper+i][5] = 0;
	 F_prime[jasper+i][6] = 0;
	 F_prime[jasper+i][7] = cbest*(2*xi[i]-2*energy0)+gbest*2*(xi[i] - energy0);
       }
...
long double Second_order_der(){
  ...
  ReadCo60();
   for(i=0; i<count;i++)
	 ...
	 F_primeprime[7][7][i] = -2*cbest+2*gbest;
   ...
   for(i=0; i<count;i++)
	 ...
	 F_primeprime[7][7][jasper+i] = -2*cbest+2*gbest;
	 }

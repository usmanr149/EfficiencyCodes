...
int SolveMatrix2(long double qMatrix[ROWS][COLS], long double qVector[ROWS], int d){
  int i=0,j=0, k=0;
   ...
   fprintf(pipe, "set xtics add ('130' 130); set xtics add ('230' 230) \n");
   ...
   fprintf(pipe, "set arrow from 130,0 to 130, %10.6Le+%10.6Le*130+%10.6Le*130*130+%10.6Le*130*130*130 nohead lc 7 lw 1\n", xVector[0], xVector[1], xVector[2], xVector[3]);
